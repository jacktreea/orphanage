        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="btn_align_right">
                    ...
                    <a href="<?= url('voluntier', "add") ?>"  data-animation="slidetogether"
                        
                        class="btn btn-primary modal_button"><i class="fa fa-plus-square"></i> Voluntier</a>
            ...
            <div class="col-lg-12 ">
                <div class="card card-body">
                    ...
                    <div class="text-center">
                        <h4 class="card-title mt-0">Voluntier</h4>
                    </div>
