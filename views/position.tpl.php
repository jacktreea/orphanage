            ...
            <div class="col-sm-12 col-md-6">
                <div class="btn_align_right">
                    ...
                    <a href="#" data-toggle="modal" data-animation="slidetogether" data-plugin="custommodal"
                        ...
                        class="btn btn-primary modal_button"><i class="fa fa-plus-square"></i> Position</a>
            ...
            <div class="col-lg-12 ">
                <div class="card card-body">
                    ...
                    <div class="text-center">
                        <h4 class="card-title mt-0">Position</h4>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a href="<?=url("position&status=edit",'edit','id='.$R['id'])?>"><button
                                                type="button"
                                                class="btn btn-outline-primary waves-effect waves-light"><i
                                                    class="mdi mdi-playlist-edit mr-2"></i>Edit</button></a>
                                        <a href="<?=url('position&status=delete','delete','id='.$R['id'])?>"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="exampleModalLabel">Position Registration</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="form" class="form-horizontal form-bordered" method="post" action="?module=position&action=save">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-5">
                                            <input type="hidden"  name="id[]" value="<?= $selected_position['id'] ?>">
                                           <label class="form-label">Position Name</label>
                                           <input type="text" placeholder="Manager" required value="<?= $selected_position['name'] ?>" class="form-control" name="name[]">
                                       </div>
                                        <div class="col-md-5">
                                            <label class="form-label">Status</label>
                                            <select name="status[]" required
                                                class=" form-control">
                                                <option <?= ($selected_position['status'] == "active"? 'selected': '') ?> value="active">Active</option>
                                                <option <?= ($selected_position['status'] == "inactive"? 'selected': '') ?> value="inactive">In-Active</option>
