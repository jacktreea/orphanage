            ...
            <div class="col-sm-12 col-md-6">
                <div class="btn_align_right">
                    ...
                    <a href="#" data-toggle="modal" data-animation="slidetogether" data-plugin="custommodal"
                        ...
                        class="btn btn-primary modal_button"><i class="fa fa-plus-square"></i> Specialization</a>
            ...
            <div class="col-lg-12 ">
                <div class="card card-body">
                    ...
                    <div class="text-center">
                        <h4 class="card-title mt-0">Specialization</h4>
                    </div>
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <?php $count=1;
                            foreach($specializations as $id=>$R) { ?>
                            <tr>
                                <td><?=$count?></td>
                                <td><?=$R['name']?></td>
                                <td><?=$R['created_at']?></td>
                                <td>
                                        ...
                                        <a href="<?=url("specialization&status=edit",'edit','id='.$R['id'])?>"><button
                                                type="button"
                                                class="btn btn-outline-primary waves-effect waves-light"><i
                                                    class="mdi mdi-playlist-edit mr-2"></i>Edit</button></a>
                                        <a href="<?=url('specialization&status=delete','delete','id='.$R['id'])?>"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="exampleModalLabel">Specialization Registration</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="form" class="form-horizontal form-bordered" method="post" action="?module=specialization&action=save">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-5">
                                            <input type="hidden"  name="id[]" value="<?= $selected_specialization['id'] ?>">
                                           <label class="form-label">Specialization Name</label>
                                           <input type="text" placeholder="Medical Doctor" required value="<?= $selected_specialization['name'] ?>" class="form-control" name="name[]">
                                       </div>
                                        <div class="col-md-5">
                                            <label class="form-label">Status</label>
                                            <select name="status[]" required
                                                class=" form-control">
                                                <option <?= ($selected_specialization['status'] == "active"? 'selected': '') ?> value="active">Active</option>
                                                <option <?= ($selected_specialization['status'] == "inactive"? 'selected': '') ?> value="inactive">In-Active</option>
