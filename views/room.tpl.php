            ...
            <div class="col-sm-12 col-md-6">
                <div class="btn_align_right">
                    ...
                    <a href="#" data-toggle="modal" data-animation="slidetogether" data-plugin="custommodal"
                        ...
                        class="btn btn-primary modal_button"><i class="fa fa-plus-square"></i> Room</a>
            ...
            <div class="col-lg-12 ">
                <div class="card card-body">
                    ...
                    <div class="text-center">
                        <h4 class="card-title mt-0">Rooms</h4>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                            ...
                                            <?php $ncount=1;
                                                foreach($R['items'] as $wkey=>$item) { ?>

                                                    <?=$item['item_name']?>
                                                     <a target="_blank" href="<?=url("item&status=edit",'edit','id='.$item['item_id'])?>"><i
                                    ...
                                    <td>
                                        <?= $R['created_at']?>
                                                    ...
                                                    <td>
                                                        <a target="_blank" href="<?=url("room&status=edit",'edit','id='.$R['room_id'])?>"><button
                                                type="button"
                                                class="btn btn-outline-primary waves-effect waves-light"><i
                                                    class="mdi mdi-playlist-edit mr-2"></i>Room</button></a>
                                                <a href="<?=url('room&status=delete','delete','id='.$R['room_id'])?>"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="exampleModalLabel">Room Registration</h5>
